...
#pragma	ADDRESS		adic_addr		005EH	/* A-D conversion interrupt control register */

#pragma	ADDRESS		capic_addr		005FH	/* Capture interrupt control register */
...
#pragma	ADDRESS		da1_addr		00DAH	/* D-A register 1 */
...
#pragma	ADDRESS		lincr2_addr		0105H	/* LIN special function register */
...
#define		dftrg_trcdf		trcdf_addr.bit.b4		/* TRCTRG pin digital filter function selection bit */
...
#define		trfm0		trfm0_addr					/* Capture / Compare0 register */
#define		trfm1		trfm1_addr					/* Compare1 register */
...
#define		tck0_trfcr0		trfcr0_addr.bit.b1		/* Timer RF count source selection bit */
#define		tck1_trfcr0		trfcr0_addr.bit.b2		/* Timer RF count source selection bit */
#define		trfc03_trfcr0	trfcr0_addr.bit.b3		/* Capture polarity select bit */
#define		trfc04_trfcr0	trfcr0_addr.bit.b4		/* Capture polarity select bit */
#define		trfc05_trfcr0	trfcr0_addr.bit.b5		/* CMP output selection bit 0 when count stops */
#define		trfc06_trfcr0	trfcr0_addr.bit.b6		/* CMP output selection bit 1 when count stops */
...
#define		tipf0_trfcr1	trfcr1_addr.bit.b0		/* TRFI filter select bit */
#define		tipf1_trfcr1	trfcr1_addr.bit.b1		/* TRFI filter select bit */
...
#define		trfc14_trfcr1	trfcr1_addr.bit.b4		/* Compare 0 output mode seelct bit */
#define		trfc15_trfcr1	trfcr1_addr.bit.b5		/* Compare 0 output mode seelct bit */
#define		trfc16_trfcr1	trfcr1_addr.bit.b6		/* Compare 1 output mode seelct bit */
#define		trfc17_trfcr1	trfcr1_addr.bit.b7		/* Compare 1 output mode seelct bit */
...
#define		adgsel0		adcon2_addr.bit.b3			/* A-D input group select bit */
#define		adgsel1		adcon2_addr.bit.b4			/* */
...
#define		md0			adcon0_addr.bit.b3			/* A-D operation mode select bit */
#define		md1			adcon0_addr.bit.b4			/* A-D operation mode select bit */
...
#define		scan0		adcon1_addr.bit.b0			/* */
...
#define		trfout0		trfout_addr.bit.b0			/* TRFO00 output enable bit 0 */
#define		trfout1		trfout_addr.bit.b1			/* TRFO01 output enable bit 1 */
#define		trfout2		trfout_addr.bit.b2			/* TRFO02 output enable bit 2 */
#define		trfout3		trfout_addr.bit.b3			/* TRFO10 output enable bit 3 */
#define		trfout4		trfout_addr.bit.b4			/* TRFO11 output enable bit 4 */
#define		trfout5		trfout_addr.bit.b5			/* TRFO12 output enable bit 5 */
#define		trfout6		trfout_addr.bit.b6			/* TRFO00 to TRFO02 output reverse bit */
#define		trfout7		trfout_addr.bit.b7			/* TRFO10 to TRFO12 output reverse bit */
...
#define		ilvl0_trfic		trfic_addr.bit.ilvl0
#define		ilvl1_trfic		trfic_addr.bit.ilvl1
#define		ilvl2_trfic		trfic_addr.bit.ilvl2
#define		ir_trfic		trfic_addr.bit.ir
...
#define		ilvl0_capic		capic_addr.bit.ilvl0
#define		ilvl1_capic		capic_addr.bit.ilvl1
#define		ilvl2_capic		capic_addr.bit.ilvl2
#define		ir_capic		capic_addr.bit.ir
