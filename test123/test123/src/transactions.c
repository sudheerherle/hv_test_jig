...
void Show_All_Transactions()
{
	...
	unsigned int color;
	Draw_Main_Window();
	//Write_Center_Text(0,TFT_SIZE_X,4,"TEST REPORTS",(unsigned far char *)&arial_narrow_bold12[0],BRIGHTBLUE,WHITE,TFT_MODE_FULL);
	...
	//Write_Text(5,36,&hv_input_text[0],(unsigned far char *)&arial_narrow_bold14[0],BLACK,WHITE,TFT_MODE_FULL);
	...
	//Write_Text(5,151,&filament_input_text[0],(unsigned far char *)&arial_narrow_bold14[0],BLACK,WHITE,TFT_MODE_FULL);
